  ...
  return (
    <div className="bg-white rounded-2xl border border-zinc-100 p-4 shadow-sm flex items-start gap-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        {loading ? (
          <div className="h-7 w-16 rounded bg-zinc-100 animate-pulse mt-1" />
        ) : (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl border border-zinc-100 p-5 shadow-sm">
            ...
            {stats.totalRevenue === 0 ? (
              <p className="text-xs text-zinc-300 mt-4">No revenue data yet</p>
            ) : (
              <div className="mt-2">
                <p className="text-2xl font-extrabold text-emerald-700 tracking-tight">
                  ৳{stats.totalRevenue.toLocaleString()}
                </p>
                <p className="text-xs text-zinc-400 mb-3">total revenue</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-zinc-100 p-5 shadow-sm">
            ...
            {stats.topTutors.length === 0 ? (
              <div className="py-8 flex flex-col items-center gap-2">
                <Users size={22} className="text-zinc-200" />
                <p className="text-xs text-zinc-300">No tutor data yet</p>
              </div>
            ) : (
              <div className="space-y-0">
                {stats.topTutors.map((tutor, i) => (
                  ...
                  >
                    <span className="text-[11px] font-extrabold text-zinc-300 w-4 shrink-0">
                      {i + 1}
                    </span>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-zinc-400 truncate">{tutor.email}</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-sm font-bold text-zinc-800">{tutor.count}</p>
                      {tutor.rating > 0 && (
